...
@AllArgsConstructor
@Builder
@Schema(description = "CLIA Member data transfer object")
public class CLIAMemberDTO {
    ...
    // Builder pattern
    public static CLIAMemberDTOBuilder builder() { return new CLIAMemberDTOBuilder(); }
    
    public static class CLIAMemberDTOBuilder {
        private Long rowId;
        private String userId;
        private LocalDateTime lastUpdateDatetime;
        private String lastUpdateUser;

        public CLIAMemberDTOBuilder rowId(Long rowId) { this.rowId = rowId; return this; }
        public CLIAMemberDTOBuilder userId(String userId) { this.userId = userId; return this; }
        public CLIAMemberDTOBuilder lastUpdateDatetime(LocalDateTime lastUpdateDatetime) { this.lastUpdateDatetime = lastUpdateDatetime; return this; }
        public CLIAMemberDTOBuilder lastUpdateUser(String lastUpdateUser) { this.lastUpdateUser = lastUpdateUser; return this; }

        public CLIAMemberDTO build() {
            CLIAMemberDTO dto = new CLIAMemberDTO();
